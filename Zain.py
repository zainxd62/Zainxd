#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To SRRDAR_ZAIN
...
CorrectUsername = "ZAINXD62
CorrectPassword = "03325922002
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Zain Professional_Hacker
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Zain Professional_Hacker
	print logo
...
def pilih_super():
	...
	def main(arg):
		...
		try:
			...
			pass #Dev:Zain Professional_Hacker
		try:
	...
	p.map(main, id)
	print "\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд\033[1;96mB4Baloch\033[1;95mтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By baloch-hacker--тАвтЧИтАв---┬╗" #Dev:Zain professional_hacker
